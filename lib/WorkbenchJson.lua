-- Small private JSON codec for the localhost workbench transport.  This
-- avoids taking an engine network-module dependency just to encode status
-- snapshots and decode the server's three command shapes.
local Json = {}
