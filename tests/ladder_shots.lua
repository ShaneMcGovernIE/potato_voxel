...
--
--   POKEPORT_DRIVER=mods/potato_voxel/tests/ladder_shots.lua \
...
return function(game)
  ...
  local handle = game.mods.exports["potato_voxel"]
  if not (handle and handle.lib) then
    print("[ladder] potato_voxel not loaded (do other voxel mods have junctions in mods/? they conflict)")
    love.event.quit(1)
    return
  end
  local V = handle.lib
